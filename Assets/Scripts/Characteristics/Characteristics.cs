...
namespace Characteristics
{
    public class Characteristics : MonoBehaviour
    {
        ...
        {
            get => _stamina;
            set => _stamina = _stamina + value > maxStamina ? maxStamina : _stamina + value;
        }
        ...
        [SerializeField]
        [Tooltip("Процент защиты")]
        private float percentageProtection = 25;
        public float PercentageProtection
        {
            get => percentageProtection;
            set => percentageProtection = value;
        }
        ...
        private void Start()
        {
            InvokeRepeating(nameof(ReplenishStamina), 0, 1);
        }
